          ...
          <div class="row">
            ...
            <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
              ...
              <div class="row">
                ...
                $Productos = Producto::getProductos($cnx);
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        ...
                        <a class="d-block" href="detail.php?prod=<?php echo $prod->id ?>"><img class="img-fluid w-100" src="/imagenes/productos/<?php echo $prod->id ?>/img_0_thumb.png" alt="..." /></a>
                      ...
                      <h6>
                        <a class="reset-anchor" href="detail.html"> <?php echo $prod->nombre ?></a>
                      </h6>
                      <p class="small text-muted"><?php echo $prod->precio ?></p>
                    </div>
